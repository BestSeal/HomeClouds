...
public class FileTree {
    ...
    private static StringBuilder RecursiveFileSearch(File fileTree, StringBuilder builder){
        ...
        builder.append("<div class = \"explorer\">").append(strDiv).append("<form method=\"post\" action=\"\"> ").append(strDiv);
        ...
        for (File file : Objects.requireNonNull(fileTree.listFiles())){
            ...
            builder.append("<img src=\"").append("..\\..\\imgs\\" + fileExtension + ".png").append("\">");
